  ...
  await Promise.all(
    ...
    const mscore = await axios.get(
        ...
        if(data) {
          ...
          if(data.data.twitter) score += 3
          if(data.data.instagram) score += 3
          if(data.data.github) score += 4
          if(data.data.site) score += 1
          if(data.data.reddit) score += 2
          if(data.data.email) score += 2
